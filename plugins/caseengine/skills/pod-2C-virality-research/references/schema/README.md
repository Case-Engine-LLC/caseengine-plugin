...
|---|---|---|
| `virality-research.json` | Scored candidate list with virality_score, tier, emotional hook category, prominence flag, signal breakdown, provenance | `/pod-3A-topic-planner` (boosts composite scores by tier) |
