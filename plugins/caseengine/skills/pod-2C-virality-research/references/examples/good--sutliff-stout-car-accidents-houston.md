...
1. **Social / community data is LLM-estimated.** Real Google Trends, subreddit activity, YouTube engagement data not available in cowork without a Fortress-proxy API. Same co-work limitation as keyword-research.
